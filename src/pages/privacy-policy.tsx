...
const PrivacyPolicy = () => {
  return (
    <main className="grid w-full gap-10 bg-aima-white px-5 py-10 md:p-20">
      <Heading variant="h1">Privacy Policy for Aima&apos;s Writing</Heading>

      <Text>
        Our Privacy Policy was last updated on{' '}
        <Text className="font-bold">Sunday 26th February, 2023</Text>
      </Text>
      ...
      <Heading>Interpretations and Definitions</Heading>

      <div className="grid w-full gap-5">
        <Heading variant="h3">Interpretation</Heading>
        <Text>
      ...
      <div className="grid w-full gap-5">
        <Heading variant="h3">Definitions</Heading>
        <Text>For the purposes of this Privacy Policy:</Text>
        <ul className="ml-5 grid list-disc gap-2 lg:ml-10">
          <li>
            <Text>
          ...
          <li>
            <Text>
              ...
              <span className="font-bold">Our</span> in this Agreement) refers
              to Aima&apos;s Writing
            </Text>
          </li>
          <li>
            <Text>
              <span className="font-bold">Country</span> refers to Nigeria
            </Text>
          </li>
          <li>
            <Text>
          ...
          <li>
            <Text>
              <span className="font-bold">Website</span> refers to Aima&apos;s,
              accessible from{' '}
              <a
                href="http://aimaswriting.com"
                target="_blank"
      ...
      <Heading variant="h1">Collecting and Using Your Personal Data</Heading>

      <Heading>Types of Data Collected</Heading>

      <div className="grid w-full gap-5">
        <Heading variant="h3">Personal Data</Heading>
      ...
      <div className="grid w-full gap-5">
        <Heading variant="h3">Usage Data</Heading>
      ...
      <div className="grid w-full gap-5">
        <Heading variant="h3">Tracking Technologies and Cookies</Heading>
        ...
        <ul className="ml-5 grid list-disc gap-2 lg:ml-10">
          ...
          <li>
            <span className="font-bold">Tracking and Performance Cookies</span>
            ...
            Website and how users use the Website. The information gathered via
            these Cookies may directly or indirectly identify you as an
      ...
      <div className="grid w-full gap-5">
        <Heading variant="h3">Business Transactions</Heading>
        <Text>
      ...
      <div className="grid w-full gap-5">
        <Heading variant="h3">Law enforcement</Heading>
        <Text>
      ...
      <div className="grid w-full gap-5">
        <Heading variant="h3">Other legal requirements</Heading>
        <Text>
      ...
      <Heading>Changes Contact Us</Heading>
        ...
        <ul className="ml-5 grid list-disc gap-2 lg:ml-10">
          <li>
            <Text>
              ...
              <a
                href="http://aiaswriting.com"
                target="_blank"
                rel="noopener noreferrer"
                className="text-primary-main underline"
              >
                http://aiaswriting.com
              </a>
            </Text>
          </li>
          <li>
            <Text>
              ...
              <a
                href="mailto:therealaimascorner@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
                className="text-primary-main underline"
              >
                therealaimascorner@gmail.com
              </a>
            </Text>
          </li>
        </ul>
